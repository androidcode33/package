      ...
      <div class="span12">
        <div class="nonboxy-widget">
          <div class="widget-head">
            <h5><i class="black-icons blocks_images"></i>FAQ PAGE </h5>
          </div>
          <div class="widget-content">
            <div class="widget-box">
<?php
					  $conn=connect_to_db();
$sql23 = mysqli_query($conn,"SELECT * FROM payment_methods where id=1") or die(mysqli_error()); 
...
$content=mysqli_real_escape_string($_POST['content']);
	...
	$conde=mysqli_query($conn,"update payment_methods set title='$title', content='$content' WHERE id='1'"); 
