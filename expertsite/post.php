    ...
    <div class="section secondary-section" id="portfolio">
        ...
        <div class="container">
			...
			<div class="span4" align="justify">	
				<div class="title2"> Login to Post your project</div>
				...
				<form action="" method="post" name="theForm" id="theForm" onSubmit="return validateForm(this)">
					...
					<p align="right" ><label>New to expertcage <a href="signup">Register</a> | <a href="recover-password">Forgot password?</a></label></p>
                </form>
        	</div>
    	</div>
	</div>
