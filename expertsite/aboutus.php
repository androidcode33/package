        ...
        <div class="container">
			 <div class="row-fluid">
                <div class="span3" align="justify">
					<div class="title2">you Need to know</div>
                	<div id="menu14">
						<ul>
				...
				<div class="span6" align="justify">
					<?php 	$query = "SELECT * FROM about_us"; $query = mysqli_query($conn,$query) or die(mysqli_error());
				...
				<div class="span3" align="justify">
					<div class="title2">Professionals</div>
					<p><img src="images/s4.png">
