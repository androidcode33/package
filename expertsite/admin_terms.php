...
<?php
					  $conn=connect_to_db();
$sql23 = mysqli_query($conn,"SELECT * FROM terms where id=1") or die(mysqli_error()); 
...
$content=mysqli_real_escape_string($_POST['content']);
	...
	$conde=mysqli_query($conn,"update terms set title='$title', content='$content' WHERE id='1'"); 
