        ...
        <div class="container">
			 <div class="row-fluid">
                <div class="span3">
					...
					<img src="images/expert1.jpg" style="border-radius:8px;">
					<h4>We send it to curated experts</h4>
					<img src="images/expert2.jpg" style="border-radius:8px;">
					<h4>job done!</h4>
					<img src="images/expert3.jpg" style="border-radius:8px;">
					<!--<div class="title2">Recent Available Jobs</div>
				...
				<div class="span9">
					<?php 	$query = "SELECT * FROM how_it_works"; $query = mysqli_query($conn,$query) or die(mysqli_error());
