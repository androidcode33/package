    ...
    <div class="section secondary-section" id="portfolio">
        ...
        <div class="container">
			...
			<div class="span6" align="center">	
				<div class="title2"> Sign-up Step #4 </div>
				<div class="alert alert-success">
                <strong>Thanks!</strong> Your account was created successfully!
				</div>
				<div class="alert alert-success">
                Wait for notification by email or SMS, once your account is approved by the support team. Search and find projects you can provide solution, bid for them and wait to be assigned to you. 
				</div>
